...
//    printf("%s\r\n", __FUNCTION__);
    *timer_h = (os_timer_h)malloc(sizeof(os_timer_t));
...
//    printf("%s\r\n", __FUNCTION__);
    ...
    pwm_drv_desc.end_value  = 32000 * 2;                // PWM end_value
...
//    printf("t\r\n");
#if (CHIP_ID == CHIP_7231U)
//    printf("REG_PWM0_CNT_END_VALUE = %ld\r\n", REG_PWM0_CNT_END_VALUE);
    if (REG_PWM0_CNT_END_VALUE == 64000)
    {
        PWM_disable(0);
        DelayMS(1);
        REG_PWM0_CNT_END_VALUE = 64001;
        DelayMS(1);
        PWM_enable(0);
        PWM_int_enable(0);
    }
    else if (REG_PWM0_CNT_END_VALUE == 64001)
    {
        PWM_disable(0);
        DelayMS(1);
        REG_PWM0_CNT_END_VALUE = PWM0_COUNT;
        DelayMS(1);
        PWM_enable(0);
        PWM_int_enable(0);
    }
