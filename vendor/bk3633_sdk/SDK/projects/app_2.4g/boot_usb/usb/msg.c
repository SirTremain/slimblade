...
//	memory_usage_show();
    ...
    temp = (uint8 *)malloc((sizeof(MSG_T) * MSG_COUNT + MSG_SECURITY_BOUNDARY_NUM + MSG_SECURITY_BOUNDARY_NUM));
    if (temp == NULL)
    {
    	 //printf("msg_init: malloc failed!\r\n");
        return;
    }
...
//    jtask_init(&msg_entity.msg_task, J_TASK_TIMEOUT);
    ...
    {
        //printf("msg_task_init_exception\r\n");
    }
    #endif
//    printf("msg_init: msg_entity.borderline = 0x%p\r\n", msg_entity.borderline);
//    printf("msg_init: msg_entity.pool = 0x%p\r\n", msg_entity.pool);
//    printf("msg_init: msg_entity.count = 0x%lx\r\n", msg_entity.count);
//    printf("msg_init: msg_entity.status = 0x%lx\r\n", msg_entity.status);
//    printf("msg_init: msg_entity.out_id = 0x%lx\r\n", msg_entity.out_id);
//    printf("msg_init: msg_entity.in_id = 0x%lx\r\n", msg_entity.in_id);
//    printf("msg_init: msg_entity.msg_task = 0x%p\r\n", msg_entity.msg_task);
//    printf("msg_init: msg_entity.arg.id = 0x%lx\r\n", msg_entity.arg.id);
//    printf("msg_init: msg_entity.arg.hdl = 0x%p\r\n", msg_entity.arg.hdl);
//    printf("msg_init: msg_entity.arg.arg = 0x%lx\r\n", msg_entity.arg.arg);
//	printf("msg_init end \r\n");
}
