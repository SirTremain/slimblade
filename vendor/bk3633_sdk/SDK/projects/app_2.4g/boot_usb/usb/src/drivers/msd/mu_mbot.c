				    ...
				    uint8_t bIsReady)
{
    ...
    MUSB_DPRINTF("MGC_BotProtocolSetReady\r\n");
    ...
    if(bIsReady)
    {
		...
		else if(!pVolume->bAnnounced)
		{
			...
			MUSB_DPRINTF("$$$$$$$ MUSB_HfiAddDevice fun\r\n");
