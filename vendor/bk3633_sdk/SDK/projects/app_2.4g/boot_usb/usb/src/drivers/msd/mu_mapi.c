...
//	MUSB_DPRINTF("MUSB_MsdConnect Function is called\r\n");
    ...
    MUSB_DPRINTF("MUSB_MsdConnect start\r\n");
    /* Device is connected */
                         ...
                         MUSB_Device    *pUsbDevice)
{
    ...
    MUSB_DPRINTF("MUSB_MsdDisconnect\r\n");
...
/*此处为设置setup configuration包*/
    ...
    MUSB_DPRINTF("MGC_MsdConfigureDevice\r\n");
...
//    uint32_t                  dwStatus;  
	...
	MUSB_DPRINTF("MGC_MsSetConfigCallback fun is called\r\n");
