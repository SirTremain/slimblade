...
/*
MUSB_DPRINTF("bEndcount:%x,sizeof(Endpointresource)=%x\r\n",pPort->bEndCount,sizeof(MGC_EndpointResource));
...
/*	else
	{
		MUSB_DPRINTF("MGC_DrcInit no memory3\r\n");
					  ...
					  uint8_t bBind, uint8_t* pbIsTx)
{
    ...
    MUSB_DPRINTF("MGC_DrcBindEndpoint: dwEndCount = %ld\r\n", dwEndCount);
...
uint32_t MGC_DrcResetPort(MGC_Port* pPort)
{
    ...
    pPort->bFuncAddr = 0;
	MUSB_DPRINTF("MGC_programbusstate\r\n");
...
//	MGC_FdrcReadBusState()
	...
	{
		MUSB_DPRINTF("MUSB_Start_Fun: =====111111===\r\n");
		MGC_DrcChangeOtgState(MUSB_A_HOST, pPort);
		MUSB_DPRINTF("MUSB_Start_Fun: =====222222===\r\n");
	}
}
