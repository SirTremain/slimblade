...
#define SEC_IMAGE_RUN_STACK_CADDR                (0x1800)///==(BOOT_MAX_SIZE/272+1)*256
#define SEC_IMAGE_RUN_STACK_FADDR                (0x20F0) /////==(BOOT_MAX_SIZE/272+1)*272
#define SEC_IMAGE_OAD_HEADER_STACK_FADDR         (0x20E0) /////==(BOOT_MAX_SIZE/272+1)*272-0x10

#define SEC_IMAGE_RUN_APP_FADDR              (0x2F040)
#define SEC_IMAGE_OAD_HEADER_APP_FADDR       (0x2F030)

#define SEC_IMAGE_ALLOC_START_STACK_FADDR    (0x2000)  //(8KB)
#define SEC_ALL_IMAGE_ALLOC_END_FADDR            (0x4b000) //(256KB)
#define SEC_ALL_BACKUP_OAD_HEADER_FADDR          (0x4b000) //256kb * 1024
#define SEC_ALL_BACKUP_OAD_IMAGE_FADDR           (0x4b010) //256kb * 1024 + 0X10
