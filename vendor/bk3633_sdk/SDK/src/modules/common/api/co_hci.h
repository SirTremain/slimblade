...
#if (FCC)
    HCI_FCC_TX_HOPPING_TEST_CMD_OPCODE             = 0x2065,
    HCI_FCC_TX_SIGNLE_TEST_CMD_OPCODE              = 0x2066,
    HCI_FCC_RX_TEST_CMD_OPCODE                     = 0x2067,

#ifdef CFG_BLE_2MBPS
    HCI_FCC_TX_V2_HOPPING_TEST_CMD_OPCODE          = 0x2068,
    HCI_FCC_TX_V2_SIGNLE_TEST_CMD_OPCODE           = 0x2069,
    HCI_FCC_RX_V2_TEST_CMD_OPCODE                  = 0x206A,

#endif // (BLE_2MBPS)
    HCI_FCC_TEST_POWER_CMD_OPCODE                  = 0x206B,
